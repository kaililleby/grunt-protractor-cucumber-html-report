    ...
    function getStep(step) {
        ...
        stepTemplate = grunt.template.process(template, {
            data: {
                ...
                screenshot_a: step.embeddings && step.embeddings[0] ? step.embeddings[0].data : '',
                screenshot_b: step.embeddings && step.embeddings[1] ? step.embeddings[1].data : '',
                screenshot_c: step.embeddings && step.embeddings[2] ? step.embeddings[2].data : ''
            }
        });
        return stepTemplate;
    }
